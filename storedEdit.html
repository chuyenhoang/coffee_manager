                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="edit__input">
                                        <input type="text" name="txt_name" value="Nhà cung cấp A">
                                    </div>
                                </div>
                            </div>   
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="edit__input">
                                        <p>Tên nhà tên nguyên vật liệu:<span>*</span></p>
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="edit__input">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="edit__input">
                                        <input type="tel" name="txt_phone" value="4">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="edit__input">
                                        <input type="text" name="txt_address" value="30.000VNĐ">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
